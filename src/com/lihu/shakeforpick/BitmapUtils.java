...
{
	public static Bitmap createQRImageByText(Context context,String text)
	{
		try
		{

			int QR_WIDTH = DensityUtil.dip2px(context, 200);
			int QR_HEIGHT = DensityUtil.dip2px(context, 200);
			// 需要引入core包
			QRCodeWriter writer = new QRCodeWriter();
			Log.i("createQRImageByText", "生成的文本：" + text);
